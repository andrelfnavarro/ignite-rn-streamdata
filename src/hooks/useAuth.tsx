...
function AuthProvider({ children }: AuthProviderData) {
  ...
  async function signIn() {
    try {
      ...
      const authUrl = `${twitchEndpoints.authorization}?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&scope=${SCOPE}&response_type=${RESPONSE_TYPE}&force_verify=${FORCE_VERIFY}&state=${STATE}`;
      ...
      throw new Error('Error authenticating to Twitch');
    } finally {
